...
const SearchAndFilter = ({setSearchNFilterVal}: SearchAndFilterProps) => {
    ...
    const [filterFields,setFilterFields] = useState({easy:false, medium:false, hard: false})
        ...
        <>
            <div className={styles.container}>
                <div className={styles.input}>
                    <Input type={'text'} id={'search'} required={false} labelText={'Puzzle List'} placeholder={'Search'} setInputVal={setSearchText}/>
                </div>
                <div>
